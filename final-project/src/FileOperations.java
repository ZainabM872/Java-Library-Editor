...
public class FileOperations {
    public static void saveToFileData(String filename, List<BookData> bookList) throws IOException {
    ...
    public static List<BookData> readFromFileData(String filename) throws IOException {
    ...
    public static void saveToFileWishlist(String filename, List<BookWishlist> wishList) throws IOException {
    ...
    public static List<BookWishlist> readFromFileWishlist(String filename) throws IOException {
