...
public class BookData extends BookTemplate {
    ...
    private static final List<BookData> bookList = new ArrayList<>();
    ...
    public boolean searchByRating(double rating) {
    ...
    public void editBookGenre(String title, String newGenre) {
    ...
    public void editBookRating(String title, double newRating) {
    ...
    public void editBookYear(String title, int newYear) {
    ...
    public void highestRated() {
        ...
        if (!bookList.isEmpty()) {
            ...
            System.out.print("The highest rated book(s) is/are: \n'" + topRated);
        } else {
            System.out.println("Your library is Empty.");
        }
    }
    public void recommendation() {
        ...
        if (!bookList.isEmpty()) {
            ...
            BookData randomBook = bookList.get(randIndex); //get a random object
            System.out.println("We recommend: " + randomBook.getTitle());
        }
        else {
            System.out.println("There are no books in the library to recommend.");
        }
    }
    public void newestEntry() {
        ...
        if (!bookList.isEmpty()) {
            ...
            System.out.println("Recently added: " + book.getTitle());
        } else {
