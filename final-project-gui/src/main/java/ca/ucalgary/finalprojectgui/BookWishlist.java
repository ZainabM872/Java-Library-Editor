...
public class BookWishlist extends BookTemplate {
    ...
    private static List<BookWishlist> wishlist = new ArrayList<>();
...
//                    System.out.println("The book '" + book.getTitle() + "' has been removed from your wishlist!");
    ...
    public boolean removeAllBooks() {
        //Clears the wishlist.
        //Clears wishlist of all its objects.
        if (!wishlist.isEmpty()) {
            wishlist.clear();
//            System.out.println("All books have been removed from the wishlist!");
            return true;
        } else {
//            System.out.println("Your wishlist is already empty!");
            return false;
        }
    }
     ...
     * Back to menu
     *
     * NO LONGER USED, GUI VERSION IS BETTER
     */
...
//        }
    ...
    public static void setWishlist(List<BookWishlist> newwishlist) {
